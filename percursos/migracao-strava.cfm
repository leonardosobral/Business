...
<cfif NOT isDefined("qPerfil") OR NOT qPerfil.recordcount>
    ...
    <cfoutput>Acesso restrito a usuarios autenticados no Business.</cfoutput>
    <cfabort/>
</cfif>
<cfinclude template="includes/migracao_strava_backend.cfm"/>
<!DOCTYPE html>
<html lang="pt-br">
...
<body data-mdb-theme="dark" class="bg-dark-subtle">
    ...
    <main style="margin-top: -55px;">
        <div class="container-fluid px-4">
            <cfinclude template="migracao-strava-home.cfm"/>
        </div>
    </main>
