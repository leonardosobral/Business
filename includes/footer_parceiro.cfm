<!--- FOOTER --->
<cfif isDefined("VARIABLES.theme") AND VARIABLES.theme EQ "dark">
    <cfset VARIABLES.footer_logo = "ffffff"/>
<cfelse>
    <cfset VARIABLES.footer_logo = "333333"/>
</cfif>
<footer class="container-fluid text-center text-lg-start d-print-none">
    <div id="sticky-stop" class="row my-3">
        <div class="col-lg-6 text-center text-lg-start">
            <a href="https://runnerhub.run/" target="_blank">
                <svg id="Camada_2" data-name="Camada 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 336.39 47.13" height="18">
                <defs>
                <style>
                .cls-1 {
                    fill: #f4b120;
        ...
        <!--- COPYRIGHT --->
            <img src="/assets/br.png" style="height: 10px; vertical-align: baseline;" alt="Feito no Brasil"> <cfoutput>#dateformat(now(), "yyyy")# RunnerHub Inteligência Esportiva</cfoutput>
        </div>
    </div>
</footer>

<!---<button onclick="topFunction()" id="scrollTop" title="Topo"><i class="fa-solid fa-chevron-up"></i></button>--->