<!--- Sidenav --->
    <nav id="main-sidenav"
         data-mdb-sidenav-init data-mdb-mode="side"
    ...
    <!---alt="RunnerHub Logo" draggable="false" class="w-responsive" />--->
        <svg id="Camada_2" data-name="Camada 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 336.39 47.13"
             class="w-responsive">
            <defs>
                <style>
                    .cls-1 {
    ...
    <li class="sidenav-item">
      <a class="sidenav-link" href="">
        ...
        <li class="sidenav-item">
            <a class="sidenav-link"><i class="fa-solid fa-book fa-fw me-3"></i><span>Documentação</span></a>
        </li>
        <li class="sidenav-item">
            <a class="sidenav-link"><i class="fa-solid fa-circle-question fa-fw me-3"></i>FAQ</a>
        </li>
        <li class="sidenav-item">
            <a class="sidenav-link"><i class="fa-solid fa-life-ring fa-fw me-3"></i>Help Desk</a>
        </li>
        <li class="sidenav-item">
            <a class="sidenav-link"><i class="fa-solid fa-message fa-fw me-3"></i>Chat</a>
        </li>
    </ul>
    </nav>
