...
<cfif VARIABLES.template EQ "/eventos/">
    ...
    <div class="row g-3">
        ...
        <cfif isDefined("VARIABLES.adminIsAdmin") AND VARIABLES.adminIsAdmin>
            <div class="col-md-2 mb-3">
                <a href="/eventos/?id_evento=0" class="btn btn-primary w-100">Novo Evento</a>
            </div>
        </cfif>
