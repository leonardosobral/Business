...
<body class="bg-dark">
    ...
    <div class="card rounded-2 border border-1 border-white text-white mb-3" style="background-color:#2e3191; width: 400px">
        ...
        <div class="card-body small p-0">
            ...
            <cfelse>
                ...
                <div class="row g-0 p-1 border-top border-1 border-white">
                    ...
                    <div class="col-6">#qEvento.nome#</div>
