...
deploy = root / '_codex/scripts/deploy_event_interest_highlights.py'
...
try:
    ...
    sys.argv = saved_argv
publisher = types.ModuleType('highlights_release')
...
class HighlightsReleaseTest(unittest.TestCase):
