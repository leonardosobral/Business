...
_QUERY_DEFINITIONS = {
    ...
    "product_summary": ("Venda de produtos sem itens de kit", "Contagem de inscrições pagas com produto não classificado como kit incluso; itens adicionais e desconhecidos permanecem visíveis, adoção usa a base paga coberta como denominador, receita considera apenas valores explícitos e o agregado Outros do gráfico conta inscrições distintas na união das categorias restantes."),
    ...
    "channel_product_mix": ("Produtos vendidos por canal", "Contagem de inscrições pagas com produto não classificado como kit incluso por canal; itens adicionais e desconhecidos permanecem visíveis e a receita inclui somente valores explícitos."),
