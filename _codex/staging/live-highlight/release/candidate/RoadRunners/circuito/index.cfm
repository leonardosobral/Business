...
<cfif qAgrega.tag EQ "live-run-xp">
    <!--- Per-visitor suggestion; shared caches must not reuse this HTML. --->
    <cfheader name="Cache-Control" value="private, no-store"/>
    <cftry>
        <cfif NOT structKeyExists(REQUEST,"LocationContext") OR NOT isStruct(REQUEST.LocationContext)>
            <cfinclude template="../includes/location.cfm"/>
        </cfif>
        <cfcatch type="any"><cfset REQUEST.LocationContext = {}/></cfcatch>
    </cftry>
</cfif>
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-6 px-lg-3 order-1 order-md-2">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade <cfif qEventosProximos.recordcount>show active</cfif> p-0" id="nav-home-2" role="tabpanel" aria-labelledby="nav-tab-2" tabindex="1">
                        ...
                        <cfif qAgrega.tag EQ "live-run-xp">
                            <cfinclude template="live_highlight.cfm"/>
                        <cfelse>
