        ...
        if (structKeyExists(APPLICATION,"audienceMeasurement") && isStruct(APPLICATION.audienceMeasurement)) {
            ...
            if (VARIABLES.audienceMeasurementDecision.allowed) {
                ...
                if (VARIABLES.audienceMeasurementService.isEnabled()) {
                    ...
                    writeOutput('<script>window.RoadRunnersAudienceConfig=' & VARIABLES.audienceMeasurementService.configJson(REQUEST.audienceMeasurementContext) & ';</script><script src="/assets/js/rr-audience.js?v=27dd026e4ad8" defer></script>');
                }
            }
        }
