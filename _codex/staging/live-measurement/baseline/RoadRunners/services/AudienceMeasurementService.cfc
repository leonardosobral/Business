component output=false {
    ...
    public struct function buildContext(required struct page, required struct requestData, required struct cgiData) {
        ...
        var familyMap = {"/"="home","/estado/"="state","/busca/"="search","/evento/"="event","/atleta/"="profile","/noticias/"="news","/videos/"="videos","/resultados/"="results","/agenda/"="calendar"};
        ...
        if (listFind("home,state,search,event,news,news_detail,videos,results,calendar",family) && len(scalar(arguments.page,"canonical"))) {
            try {
