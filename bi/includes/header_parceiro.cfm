<div class="row mb-3">
    ...
    <cfif isDefined("VARIABLES.theme") AND VARIABLES.theme EQ "dark">
        <cfset VARIABLES.header_logo = "ffffff"/>
    <cfelse>
        <cfset VARIABLES.header_logo = "333333"/>
    </cfif>
                ...
                <svg id="Camada_2" data-name="Camada 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 336.39 47.13" height="36">
                    <defs>
                        <style>
                            ...
                            .cls-2 {
                                fill: #<cfoutput>#VARIABLES.header_logo#</cfoutput>;
                            }
                        </style>
                    </defs>
    ...
    <!---div class="col-md-2 p-0">
        <a href="https://runnerhub.run/" target="_blank"><img src="../../assets/rh_icon.jpg" class="w-50px rounded-5 shadow-5 mx-1 px-1"/></a>
        <a href="https://roadrunners.run/" target="_blank"><img src="../../assets/rr_icon.jpg" class="w-50px rounded-5 shadow-5 mx-1 px-1"/></a>
        <a href="https://openresults.run/" target="_blank"><img src="../../assets/or_icon.jpg" class="w-50px rounded-5 shadow-5 mx-1 px-1"/></a>
    </div--->
