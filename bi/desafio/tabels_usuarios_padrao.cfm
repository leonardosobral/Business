<div class="table-wrapper-lg">
    ...
    <table id="tblEventos" class="table table-stripped table-condensed table-sm mb-0">
        ...
        <tr style="font-size: small;">
            ...
            <td class="text-start">
                <cfif len(trim(qStatsEvento.strava_code))><a target="_blank" href="https://roadrunners.run/api/strava/atualizar/?id_usuario=#id#&token=#urlEncodedFormat(structKeyExists(APPLICATION, 'eventoApiToken') ? APPLICATION.eventoApiToken : '')#&debug=true"><div class="badge bg-strava"><i class="fa fa-refresh"></i></div></a> <a target="_blank" href="https://roadrunners.run/api/strava/atualizar/?id_usuario=#id#&token=#urlEncodedFormat(structKeyExists(APPLICATION, 'eventoApiToken') ? APPLICATION.eventoApiToken : '')#&debug=true&full=true"><div class="badge bg-black me-1"><i class="fa fa-refresh"></i></div></a>
