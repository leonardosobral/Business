...
<cfinclude template="includes/backend/backend_stats_rr.cfm"/>
        ...
        <div class="container-fluid mt-3">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select data-mdb-select-init data-mdb-visible-options="12" class="form-select" onchange="window.location.href='<cfoutput>./stats_rr.cfm?regiao=#URL.regiao#&estado=#URL.estado#&cidade=#URL.cidade#&preset=</cfoutput>' + this.value">>
                        ...
                        <option value="28dias" <cfif URL.preset EQ "28dias">selected</cfif> >28 dias</option>
                    </select>
                                    ...
                                    <div class="table-wrapper">
                                        ...
                                        <table id="tblEventos" class="table table-stripped table-hovered table-condensed table-sm mb-0" >
                                            <cfoutput query="qStatsRegiao">
                                                <tr style="cursor: pointer;" <cfif qStatsRegiao.regiao EQ URL.regiao>class="table-active" onclick="location.href = './stats_rr.cfm?preset=#URL.preset#'"<cfelse>onclick="location.href = './stats_rr.cfm?preset=#URL.preset#&regiao=#urlEncodedFormat(qStatsRegiao.regiao)#'"</cfif> >
                                    ...
                                    <div class="table-wrapper">
                                        ...
                                        <table id="tblEventos" class="table table-stripped table-condensed table-sm mb-0" >
                                            <cfoutput query="qStatsEstado">
                                                <tr style="cursor: pointer;" <cfif qStatsEstado.estado EQ URL.estado>class="table-active" onclick="location.href = './stats_rr.cfm?preset=#URL.preset#&regiao=#URL.regiao#'"<cfelse>onclick="location.href = './stats_rr.cfm?preset=#URL.preset#&regiao=#URL.regiao#&estado=#urlEncodedFormat(qStatsEstado.estado)#'"</cfif> >
                                    ...
                                    <div class="table-wrapper">
                                        ...
                                        <table id="tblEventos" class="table table-stripped table-condensed table-sm mb-0" >
                                            <cfoutput query="qStatsCidade">
                                                <tr style="cursor: pointer;" <cfif qStatsCidade.cidade EQ URL.cidade>class="table-active"  onclick="location.href = './stats_rr.cfm?preset=#URL.preset#&regiao=#URL.regiao#&estado=#URL.estado#'"<cfelse>onclick="location.href = './stats_rr.cfm?preset=#URL.preset#&regiao=#URL.regiao#&estado=#URL.estado#&cidade=#urlEncodedFormat(qStatsCidade.cidade)#'"</cfif> >
