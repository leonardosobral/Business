...
| Jornal da Corrida | `https://conteudo.roadrunners.run/admin/importer_jornalcorrida` | `https://conteudo.roadrunners.run/api/admin/importers/jornalcorrida.cfm` | 60 min |
