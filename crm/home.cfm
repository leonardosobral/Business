          ...
          <table class="table table-sm table-striped table-hover">
              ...
              <tbody>
                <cfoutput query="qFilaEmail">
                    <tr>
                        <td>
                            <a href="/crm/?campanha=#qFilaEmail.id_mailing#&acao=status_campanha&status=3"><icon class="fa fa-pause"></icon></a>
                            <a href="/crm/?campanha=#qFilaEmail.id_mailing#&acao=status_campanha&status=4"><icon class="fa fa-archive"></icon></a>
                            <a href="/crm/?campanha=#qFilaEmail.id_mailing#&acao=editar"><icon class="fa fa-edit"></icon></a>
                        </td>
