...
<cfif isDefined("COOKIE.id")>
    ...
    <cfif isDefined("qCheckStrava") AND qCheckStrava.recordcount>
        ...
        <form class="row g-3 needs-validation" novalidate method="post" action="/carteira/?<cfif isDefined("URL.debug")>debug=true&</cfif>token=<cfoutput>#tobase64('roadrunners:'&now())#</cfoutput>">
            ...
            <div class="col-3">
                <div class="form-outline" data-mdb-input-init>
                    <input type="text" class="form-control" id="inputAssessoria" required maxlength="4" name="usuario_ddi" value="<cfoutput>#qPerfilCheckCompleto.ddi_usuario#</cfoutput>"/>
            ...
            <div class="col-md-12">
                <div class="form-outline" data-mdb-input-init>
                    <input type="text" class="form-control" id="inputDocumento" required maxlength="50" name="usuario_documento"/>
                    <label for="inputDocumento" class="form-label">Passaporte</label>
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="form-outline" data-mdb-input-init>
                    <input type="text" class="form-control" id="inputEstado"  maxlength="2" name="endereco_estado" value="<cfoutput>#qPerfilCheckCompleto.estado#</cfoutput>"/>
