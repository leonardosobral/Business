...
<cftry>
    <cfquery name="qCadastroSolicitacaoTableCheck">
        ...
        WHERE table_schema = 'public'
          AND table_name = <cfqueryparam cfsqltype="cf_sql_varchar" value="tb_conta_cadastro_solicitacoes"/>
    </cfquery>

    <cfset VARIABLES.cadastroSolicitacaoTablesReady = qCadastroSolicitacaoTableCheck.recordcount GT 0/>
