...
<cfif VARIABLES.adsAccessCanManageCampaign
    AND FORM.ads_v1_action EQ "save_campaign"
    AND len(VARIABLES.adsV1Error)>
...
<section class="mb-4">
  <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-end gap-3">
    <div>
      <div class="ads-v1-eyebrow">Marketing</div>
      <h1 class="h3 mb-0">Publicidade</h1>
      <p class="text-muted mb-0 mt-2">Crie campanhas e acompanhe saldo, investimento e desempenho da conta selecionada.</p>
    </div>
    <div class="d-flex flex-wrap gap-2">
      <cfif VARIABLES.adsAccessCanManageCampaign AND VARIABLES.adsV1HasAccount AND VARIABLES.adsV1ApiReady>
        <a class="btn btn-info" href="./#campaign-form">Nova campanha</a>
      </cfif>
    </div>
  </div>
</section>
...
<cfif NOT VARIABLES.adsV1HasAccount>
  <section class="card shadow-0 mb-4">
    <div class="card-body p-4">
      ...
      <p class="text-muted mb-0">A publicidade exige uma conta ativa. Escolha uma conta no seletor superior e volte a esta pagina.</p>
    </div>
  </section>
<cfelseif NOT VARIABLES.adsAccessCanView>
  <section class="card shadow-0 mb-4">
    <div class="card-body p-4">
      <div class="ads-v1-eyebrow mb-2">Acesso restrito</div>
      <h2 class="h5">Seu papel nao permite acessar Publicidade</h2>
      <p class="text-muted mb-0">Solicite ao responsavel pela conta um vinculo ativo com acesso de visualizacao.</p>
    </div>
  </section>
<cfelseif NOT VARIABLES.adsV1ApiReady>
  <section class="card shadow-0 mb-4">
    <div class="card-body p-4">
      ...
      <h2 class="h5">API de publicidade indisponivel</h2>
      ...
      <a class="btn btn-outline-warning" href="/ads/">Voltar para Publicidade</a>
    </div>
  </section>
...
<cfelse>
  <section class="mb-4">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 g-3">
      <div class="col"><div class="card ads-v1-summary h-100"><div class="card-body"><div class="text-muted small mb-2">Saldo disponivel</div><div class="ads-v1-summary-value"><cfoutput>#lsCurrencyFormat(VARIABLES.adsV1Summary.balance)#</cfoutput></div><div class="small text-muted mt-2">BRL disponivel</div></div></div></div>
      ...
      <div class="col"><div class="card ads-v1-summary h-100"><div class="card-body"><div class="text-muted small mb-2">Gasto total</div><div class="ads-v1-summary-value"><cfoutput>#lsCurrencyFormat(VARIABLES.adsV1Summary.spent)#</cfoutput></div><div class="small text-muted mt-2">ledger e budget state</div></div></div></div>
  ...
  <cfif VARIABLES.adsV1Summary.active GT 0 AND VARIABLES.adsV1Summary.balance LTE 0>
    <div class="alert alert-warning d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
      <div><strong>Campanha ativa sem saldo.</strong> A configuracao continua salva, mas a campanha nao participa da veiculacao CPC ate a conta receber credito.</div>
      <cfif VARIABLES.adsAccessCanPurchaseCredit>
        <a class="btn btn-sm btn-outline-warning flex-shrink-0" href="./#payment-credit">Adicionar credito</a>
      </cfif>
    </div>
  </cfif>

  <cfinclude template="includes/payments_home.cfm"/>
  ...
  <section class="card shadow-0 mb-4">
    <div class="card-body p-3 p-lg-4">
      <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 mb-3">
        ...
        <cfelse>
          <span class="badge badge-secondary align-self-lg-start">Somente leitura</span>
        </cfif>
      </div>
            ...
            <tbody>
              <cfoutput query="qAdsV1Campaigns">
                <tr>
                  ...
                  <td>
                    <span class="badge <cfif status EQ 'ACTIVE'>badge-success<cfelseif status EQ 'PAUSED'>badge-warning<cfelseif status EQ 'ENDED'>badge-danger<cfelse>badge-secondary</cfif>">#htmlEditFormat(status)#</span>
                    <cfif status EQ "ACTIVE" AND VARIABLES.adsV1Summary.balance LT cpc_bid>
                      <div class="small text-warning mt-1">Sem saldo para o CPC</div>
                    </cfif>
                  </td>
      ...
      <cfelse>
        <div class="alert alert-info mb-0">Esta conta ainda nao possui campanhas.</div>
      </cfif>
    </div>
  </section>
  ...
  <section class="card shadow-0 mb-4" id="campaign-form">
    <div class="card-body p-3 p-lg-4">
      ...
      <cfelseif NOT qAdsV1Placements.recordcount>
        <div class="alert alert-warning mb-0">Nenhum spot nativo de publicidade esta disponivel para configuracao.</div>
      <cfelse>
  ...
  <section class="mb-3">
    <div class="ads-v1-eyebrow">Operacao interna</div>
    <h2 class="h5 mb-1">Administracao financeira</h2>
    <p class="text-muted mb-0">Credito manual e correcoes ficam separados da compra do anunciante.</p>
  </section>
    ...
    <div class="col-xl-4">
      <section class="card shadow-0 h-100">
        <div class="card-body p-3 p-lg-4">
          ...
          <p class="text-muted">O credito entra no saldo da conta em BRL.</p>
          <form method="post" action="./">
    ...
    <div class="col-xl-8">
      <section class="card shadow-0 h-100">
        <div class="card-body p-3 p-lg-4">
          ...
          <h2 class="h5">Movimentacoes recentes</h2>
          <div class="table-responsive">
            <table class="table table-sm align-middle mb-0"><thead><tr><th>Data</th><th>Tipo</th><th>Campanha</th><th class="text-end">Valor</th><th class="text-end">Saldo</th></tr></thead><tbody>
              ...
              <cfelse><tr><td colspan="5" class="text-muted text-center py-4">Nenhum lancamento.</td></tr></cfif>
            </tbody></table>
          </div>
        </div>
      </section>
  ...
  <cfinclude template="includes/legacy_history.cfm"/>
</cfif>
