...
<cfset VARIABLES.template = "/ads/legacy/"/>
        ...
        <main class="container py-5">
            <div class="card shadow-0">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">O historico anterior esta disponivel somente para administradores internos.</p>
                    <a class="btn btn-warning" href="/ads/">Voltar para Publicidade</a>
                </div>
            </div>
        </main>
    </body>
